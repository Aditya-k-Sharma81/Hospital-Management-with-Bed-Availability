...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      <img onClick={() => navigate("/")} src={assets_frontend.logo} className='w-44 cursor-pointer' />
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        <NavLink to="/">
          <li className='py-1'>HOME</li>
          <hr className='border-none outline-none h-0.5 w-3/5 m-auto hidden' style={{ background: "#5f6FFF" }} />
        </NavLink>
      ...
      <div className='flex items-center gap-4'>
            ...
            <div className='flex items-center gap-2 cursor-pointer relative group'>
              ...
              <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                  ...
                  <p onClick={() => navigate('/my-receipts')} className='hover:text-black cursor-pointer'>My Receipts</p>
        ...
        <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          <div className='flex items-center justify-between px-5 py-6'>
            ...
            <img className='w-7' onClick={() => setShowMenu(false)} src={assets_frontend.cross_icon} />
          </div>
