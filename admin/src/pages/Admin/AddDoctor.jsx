      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          <label htmlFor="doc-img">
            <img className="w-16 h-16 bg-gray-100 rounded-full cursor-pointer object-cover" src={docImg ? URL.createObjectURL(docImg) : assets.upload_area} alt="Upload"/>
          </label>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-1'>
              <p>Speciality</p>
              <select name="speciality" className='border rounded px-3 py-2' onChange={(e)=>setSpeciality(e.target.value)} value={speciality}>
        ...
        <button type='submit' className='px-10 py-3 mt-4 bg-[#5F6FFF] text-white rounded-full cursor-pointer'>Add doctor</button>
      </div>
    </form>
  )
}
